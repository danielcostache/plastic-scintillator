...
void myDetectorConstruction::ConstructScintillator() {
    ...
    G4double radDet=7.5*cm, widthDet=1.*mm, widthCase=0.1*mm, zDet=7*cm;
    ...
    G4VPhysicalVolume   *physCase2  = new G4PVPlacement(0, G4ThreeVector(0., 0., zDet-widthDet/2-widthCase/2), logicCase2, "physCase2", logicWorld, false, 0, true);
